...
#Program for implementing greedy search algorithm
...
class puzzle:
    ...
    # Method for calculating Manhattan distance heuristics
    def manhattan(self):
        h = 0
    ...
    # Method for calculating mmisplaced tiles heuristics
...
#Method to implement Greedy  search algorithm --> f(n) = h(n)
def greedy(start):
    openList = []
    closedList = []
                ...
                for j, item in enumerate(openList):
                    if item == move:
                        ...
                        if newG < openList[j].g:
                            openList[j].g = newG
                            openList[j].f = openList[j].h
                            openList[j].parent = current
                if not present:
                    move.g = newG
                    #Below method should be changed to "misplaced_tiles" for misplaced tiles heuristics
...
def writetofile(start,time,filename,result):
...
result1 = greedy(start1)
end_time1 = timeit.default_timer()
time1 = end_time1-start_time1
noofMoves1 = 0
writetofile(start_state1,time1,"Greedy_state1.txt",result1)
...
result2 = greedy(start2)
end_time2 = timeit.default_timer()
time2 = end_time2-start_time2
noofMoves2 = 0
writetofile(start_state2,time2,"Greedy_state2.txt",result2)
#printing results in terminal
if(not result2):
    print ("No solution")
else:
    ...
    while t:
        ...
        print(t.board)
        t=t.parent
print("Start state1:",start_state2)
...
result3 = greedy(start3)
end_time3 = timeit.default_timer()
time3 = end_time3-start_time3
noofMoves3 = 0
writetofile(start_state3,time3,"Greedy_state3.txt",result3)
#printing results in terminal
if(not result3):
    print ("No solution")
else:
